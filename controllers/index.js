...
document.querySelector("#typeOption").oninput = () => {
  ...
  if (opt == "student") {
    output = `
                  <div>
                          <input  name="math" id="diemToan" class="form-control input-sm"
                          placeholder="Điểm toán"/>
                  </div>
                  <span class="sp-thongbao" id="tbToan"></span>
                  <div >
                          <input name="physic" id="diemLy" class="form-control input-sm"
                          placeholder="Điểm lý"/>
                  </div>
                  <span class="sp-thongbao" id="tbPhysic"></span>
                  <div >
                          <input name="chemistry" id="Diemhoa" class="form-control input-sm"
